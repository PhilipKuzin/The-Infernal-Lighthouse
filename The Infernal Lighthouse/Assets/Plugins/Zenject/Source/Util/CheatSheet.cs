...
namespace Zenject
{
    public class CheatSheet : Installer<CheatSheet>
    {
        public override void InstallBindings()
        {
            ...
            Container.BindIntefacesAndSelfTo<Foo>().AsTransient();

            // Create a new instance of Foo for every class that asks for an IFoo
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().AsTransient();
            ...
            Container.BindIntefacesAndSelfTo<Foo>().AsSingle();

            // Create one definitive instance of Foo and re-use that for every class that asks for IFoo
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().AsSingle();
            ...
            Container.BindIntefacesAndSelfTo<Foo>().FromInstance(new Foo());
            ...
            Container.BindIntefacesAndSelfTo<int>().FromInstance(10);
            Container.BindIntefacesAndSelfTo<bool>().FromInstance(false);
            ...
            Container.BindIntefacesAndSelfTo<Foo>().FromMethod(GetFoo);
            ...
            Container.BindIntefacesAndSelfTo<IFoo>().FromMethod(GetRandomFoo);

            // You an also use an anonymouse delegate directly
            Container.BindIntefacesAndSelfTo<Foo>().FromMethod(ctx => new Foo());

            // This is equivalent to AsTransient
            Container.BindIntefacesAndSelfTo<Foo>().FromMethod(ctx => ctx.Container.Instantiate<Foo>());
        ...
        void InstallMore()
        {
            ...
            Container.BindIntefacesAndSelfTo<Bar>().FromResolveGetter<Foo>(foo => foo.GetBar());

            // Another example using values
            Container.BindIntefacesAndSelfTo<string>().FromResolveGetter<Foo>(foo => foo.GetTitle());

            ///////////// FromNewComponentOnNewGameObject

            // Create a new game object at the root of the scene and add the Foo MonoBehaviour to it
            Container.BindIntefacesAndSelfTo<Foo>().FromNewComponentOnNewGameObject().AsSingle();

            // You can also specify the game object name to use using WithGameObjectName
            Container.BindIntefacesAndSelfTo<Foo>().FromNewComponentOnNewGameObject().WithGameObjectName("Foo1").AsSingle();

            // Bind to an interface instead
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().FromNewComponentOnNewGameObject().AsSingle();
            ...
            Container.BindIntefacesAndSelfTo<Foo>().FromComponentInNewPrefab(prefab).AsSingle();

            // Bind to interface instead
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().FromComponentInNewPrefab(prefab).AsSingle();
            ...
            Container.BindIntefacesAndSelfTo<Foo>().FromComponentInNewPrefab(prefab).AsTransient();

            // Bind to interface instead
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().FromComponentInNewPrefab(prefab);
            ...
            // that instead
            Container.BindIntefacesAndSelfTo<string>().WithId("PlayerName").FromInstance("name of the player");
        ...
        public void InstallMore2()
        {
            ...
            Container.BindIntefacesAndSelfTo<Foo>().AsCached();
            Container.BindIntefacesAndSelfTo<Foo>().WithId("FooA").AsCached();
            Container.BindIntefacesAndSelfTo<Foo>().WithId("FooA").AsCached();
        ...
        public void InstallMore3()
        {
            ...
            Container.BindIntefacesAndSelfTo<Foo>().AsSingle().WhenInjectedInto<Bar>();

            // Use different implementations of IFoo dependending on which
            // class is being injected
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo1>().AsSingle().WhenInjectedInto<Bar>();
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo2>().AsSingle().WhenInjectedInto<Qux>();
            ...
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo1>().AsSingle();
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo2>().AsSingle().WhenInjectedInto<Qux>();

            // Allow depending on Foo in only a few select classes
            Container.BindIntefacesAndSelfTo<Foo>().AsSingle().WhenInjectedInto(typeof(Bar), typeof(Qux), typeof(Baz));
            ...
            // for that case
            Container.BindIntefacesAndSelfTo<IFoo>().To<Foo>().AsTransient().When(
            ...
            Container.BindIntefacesAndSelfTo<Bar>().WithId("Bar1").AsCached();
            Container.BindIntefacesAndSelfTo<Bar>().WithId("Bar2").AsCached();
            ...
            Container.BindIntefacesAndSelfTo<Foo>().FromComponentInNewPrefab(fooPrefab).AsSingle();
            Container.BindIntefacesAndSelfTo<IBar>().To<Foo>().FromResolve();
            Container.BindIntefacesAndSelfTo<IFoo>().To<IBar>().FromResolve();
