...
public class Player : MonoBehaviour, IDamageable, IEnemyTarget
{
    ...
    private void IncreaseFragsÑount(RaycastHit hitInfo)  // äîáàâëåíî 25.06! óâåëè÷åíèå ñ÷åò÷èêà ôðàãîâ è ïðîâåðêà íà ëåâåëÀï ÑÄÅËÀÒÜ ÍÎÐÌÀËÜÍÎ
                                                         // ïåðåäàåòñÿ íåíóæíûé ïàðàìåòð, ïîäóìàòü êàê èñïðàâèòü
    {
        FragsCounter++;
